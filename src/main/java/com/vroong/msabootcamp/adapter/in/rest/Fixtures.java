...
public class Fixtures {
  ...
  public static SingerDto aSingerDto() {
    return new SingerDto().singerId(DEFAULT_ID).name(DEFAULT_SINGER_NAME);
  }

  public static SongDto aSongDto() {
    return new SongDto().songId(DEFAULT_ID).title(DEFAULT_SONG_TITLE).playTime(DEFAULT_PLAY_TIME);
  }
